...
/***/ function(module, exports, __webpack_require__) {
	...
	Router.run(routes, function (Root) {
		React.render(React.createElement(Root, null), document.getElementById("output"));
	});
	...
	var Notes = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(AddNote, { username: this.username, addNote: this.props.addNote }),
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("input", { type: "text", className: "form-control", ref: "note", placeholder: "new note" }),
					React.createElement(
						"span",
